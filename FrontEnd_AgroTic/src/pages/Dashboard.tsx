...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen flex flex-col">
      <h1 className="text-3xl font-bold mb-6 text-gray-800">Bienvenido al sistema AgroTic</h1>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-40">
            {/* Environmental Data Card - Now in first position */}
            ...
            {/* Welcome Card - Now in second position with centered content */}
            <Card className="shadow-lg hover:shadow-xl transition-shadow h-full flex flex-col">
              <CardHeader className="flex items-center gap-3">
          ...
          {/* Last Sale Card - Replaced notifications */}
          <Card className="shadow-lg hover:shadow-xl transition-shadow">
            <CardHeader className="flex items-center gap-3">
          ...
          {/* Last Harvest Card - Moved here */}
          <Card className="shadow-lg hover:shadow-xl transition-shadow h-50">
            <CardHeader className="flex items-center gap-3">
