...
export class InitialSchema1763666931019 implements MigrationInterface {
    name = 'InitialSchema1763666931019'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "zona_mqtt_config" ("pk_id_zona_mqtt_config" uuid NOT NULL DEFAULT uuid_generate_v4(), "fk_id_mqtt_config" uuid NOT NULL, "fk_id_zona" uuid NOT NULL, "zmc_estado" boolean NOT NULL DEFAULT true, "zmc_umbrales" jsonb NOT NULL DEFAULT '{}', "zmc_created_at" TIMESTAMP NOT NULL DEFAULT now(), "zmc_updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_764b7bca78c91fb0737c627eba4" PRIMARY KEY ("pk_id_zona_mqtt_config"))`);
        await queryRunner.query(`CREATE TABLE "medicion_sensor" ("pk_id_medicion" uuid NOT NULL DEFAULT uuid_generate_v4(), "med_key" character varying(50) NOT NULL, "med_valor" numeric(10,2) NOT NULL, "med_fecha_medicion" TIMESTAMP NOT NULL, "med_unidad" character varying(20), "fk_id_zona_mqtt_config" uuid NOT NULL, CONSTRAINT "PK_93f31099faa603caa41f2311044" PRIMARY KEY ("pk_id_medicion"))`);
