...
export class InitialSchema1765146432842 implements MigrationInterface {
    name = 'InitialSchema1765146432842'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mqtt_config" ("pk_id_mqtt_config" uuid NOT NULL DEFAULT uuid_generate_v4(), "mc_nombre" character varying(100) NOT NULL, "mc_host" character varying(255) NOT NULL, "mc_port" integer NOT NULL, "mc_protocol" character varying(10) NOT NULL, "mc_topic_base" character varying(255) NOT NULL, "mc_activa" boolean NOT NULL DEFAULT true, "mc_umbrales" jsonb NOT NULL DEFAULT '{}', CONSTRAINT "PK_8c821100a5c36655ac2c5010f10" PRIMARY KEY ("pk_id_mqtt_config"))`);
        ...
        await queryRunner.query(`CREATE TABLE "medicion_sensor" ("pk_id_medicion" uuid NOT NULL DEFAULT uuid_generate_v4(), "med_key" character varying(50) NOT NULL, "med_valor" numeric(10,2) NOT NULL, "med_fecha_medicion" TIMESTAMP NOT NULL, "med_unidad" character varying(20), "med_tipo" character varying(20) NOT NULL DEFAULT 'regular', "fk_id_zona_mqtt_config" uuid NOT NULL, CONSTRAINT "PK_93f31099faa603caa41f2311044" PRIMARY KEY ("pk_id_medicion"))`);
        ...
        await queryRunner.query(`CREATE TABLE "zonas" ("pk_id_zona" uuid NOT NULL DEFAULT uuid_generate_v4(), "zon_nombre" character varying(50) NOT NULL, "zon_coordenadas" jsonb NOT NULL, "zon_area_metros_cuadrados" numeric(10,2), CONSTRAINT "PK_ed479402d4f4ca15c7d322f09a9" PRIMARY KEY ("pk_id_zona"))`);
